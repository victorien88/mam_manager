...
# Form implementation generated from reading ui file '/home/romain/mam_manager/IngestWizard.ui'
#
# Created: Sun Mar 15 18:37:48 2015
...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        self.l_city = QtGui.QLineEdit(self.groupBox_2)
        self.l_city.setObjectName("l_city")
        self.verticalLayout_3.addWidget(self.l_city)
        ...
        self.t_model = QtGui.QLineEdit(self.groupBox_2)
        ...
        self.t_clips.setAutoFillBackground(True)
        ...
        Wizard.setTabOrder(self.ch_h264, self.l_key)
        Wizard.setTabOrder(self.l_key, self.l_city)
        Wizard.setTabOrder(self.l_city, self.dateEdit)
        Wizard.setTabOrder(self.dateEdit, self.t_model)
        Wizard.setTabOrder(self.t_model, self.checkBox_2)
        Wizard.setTabOrder(self.checkBox_2, self.l_own)
        Wizard.setTabOrder(self.l_own, self.b_browse)
        Wizard.setTabOrder(self.b_browse, self.l_cardpath)
        Wizard.setTabOrder(self.l_cardpath, self.t_clips)
    ...
    def retranslateUi(self, Wizard):
        ...
        self.groupBox_3.setTitle(QtGui.QApplication.translate("Wizard", "Type de carte", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton_2.setText(QtGui.QApplication.translate("Wizard", "Carte Vidéo", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton.setText(QtGui.QApplication.translate("Wizard", "Carte Audio", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_9.setText(QtGui.QApplication.translate("Wizard", "Pays", None, QtGui.QApplication.UnicodeUTF8))
        self.label_16.setText(QtGui.QApplication.translate("Wizard", "Ville", None, QtGui.QApplication.UnicodeUTF8))
